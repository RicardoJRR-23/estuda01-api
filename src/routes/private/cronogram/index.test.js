...
const { Cronogram } = require('../../../models');
...
describe('Router Tests ', () => {
  ...
  describe('Success Cases', () => {
    ...
    it('should return 201 if created a cronograma successfully', async () => {
      ...
      const cronogram = await Cronogram.findOne({ userId: user_id });
      const cronogram_object = cronogram.toObject();

      expect(cronogram).not.toBeNull();
      expect(cronogram_object).toMatchObject({
        title: payload.title,
