...
describe('Router Tests ', () => {
  ...
  describe('Success Cases', () => {
    ...
    it('Should return 201 if description is missing and tasks fields', async () => {
      // Correctly filled form payload
      const payload = {
        title: 'Novo Cronograma',
        startDate: '2024-01-01',
    ...
    it('Should return 201 if description is an empty and task is an empty array', async () => {
  ...
  describe('Error Cases', () => {
    describe('400 Bad Request', () => {
      describe('Unexpected Field Values', () => {
        it('Should return 400 if there is an unexpected field in the request', async () => {
      ...
      describe('Invalid Fields', () => {
        it('Should return 400 if the  required "title" field  is invalid', async () => {
          // Invalid values ​​for fields title
          const invalid_answers = [undefined, null, '', 0, false, [], {}];
          for (let i = 0; i < invalid_answers.length; i++) {
            const payload = {
              title: invalid_answers[i],
              description: 'Detalhes do erro',
        ...
        it('Should return 400 if the required "startDate" field is invalid', async () => {
          // Invalid values ​​for fields startDate
        ...
        it('Should return 400 if the required "endDate" field  is invalid', async () => {
          // Invalid values ​​for fields startDate
          const invalid_answers = [
            undefined,
            null,
        ...
        it('Should return 400 if there are multiple invalid fields', async () => {
          // Invalid values ​​for fields startDate
          const invalid_title = null;
          const invalid_description = 0;
          const invalid_date = '31_01_2024';
          const payload = {
            title: invalid_title,
          ...
          expect(date_regex.test(invalid_date)).toBe(false);
      ...
      describe('Missing Fields', () => {
        it('Should return 400 if the  the required "title" field  is missing', async () => {
          // Invalid values ​​for fields title
        ...
        it('Should return 400 if the the required "startDate" field is missing', async () => {
          const payload = {
            title: 'Titulo do erro 400',
            description: 'Detalhes do erro',
            endDate: '2024-01-31',
        ...
        it('Should return 400 if the the required "endDate" field  is missing', async () => {
          const payload = {
            title: 'Titulo do erro 400',
            description: 'Detalhes do erro',
            startDate: '2024-01-01',
        ...
        it('Should return 400 if the object is empty', async () => {
          // Invalid values ​​for fields startDate
